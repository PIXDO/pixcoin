...
{
    return GetBoolArg("-testnet", false) ? 40302 : 40307;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Pixcoin server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: pixcoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        || weakPassword(mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use pixcoind";
