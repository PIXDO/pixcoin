...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pixcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pixcoin.com", "seed.pixcoin.com"},
    {"pixchain.info", "seed.pixchain.info"},
    {"mophides.com", "seed.mophides.com"},
    {"dglibrary.org", "seed.dglibrary.org"},
//    {"pixcoinpool.org", "dnsseed.pixcoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pixcoin is probably already running."), addrBind.ToString().c_str());
        else
